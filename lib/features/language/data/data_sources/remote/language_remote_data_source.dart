  ...
  Future<List<ResponseEntity>> get() async{
    try{
      ...
      final Response<dynamic> response = await _dio.get(
        'https://96.9.67.188:4434/api/languages',
        options: Options(
          headers: {
      ...
      if(response.statusCode == 200){
        ...
        final List<dynamic> parsed = json['Data'];
        return parsed.map<LanguageModel>((e) => LanguageModel.fromJson(json: e)).toList();
      }
      throw ServerFailure(message: 'Get Data Failed');
    }
    on Failure{
      rethrow;
    }
    catch(e){
      throw ServerFailure(message: 'Cannot Get Data From API! : ${e.toString()}');
    }
  }
}